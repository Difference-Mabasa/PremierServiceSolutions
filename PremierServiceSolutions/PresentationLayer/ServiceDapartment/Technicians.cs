    ...
    public partial class Technicians : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex].Selected == true)
            {
                ...
                jb.Duration = int.Parse(dataGridView1.Rows[e.RowIndex].Cells[3].FormattedValue.ToString());
                jb.Description = dataGridView1.Rows[e.RowIndex].Cells[4].FormattedValue.ToString();
                jb.Status = dataGridView1.Rows[e.RowIndex].Cells[5].FormattedValue.ToString();
                jb.EmployeeID = dataGridView1.Rows[e.RowIndex].Cells[6].FormattedValue.ToString();
