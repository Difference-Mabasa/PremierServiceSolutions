...
{
    public partial class ContractMaintanence : Form
    {
        ...
        private void ibtnContracts_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new ContractMaintanance());
        }
        ...
        private void ContractMaintanence_Load(object sender, EventArgs e)
        {
